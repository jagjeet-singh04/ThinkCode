...
const Pricing = () => (
  <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[#0d1117] via-[#161b22] to-[#0d1117] text-[#c9d1d9] px-4 py-16">
    <div className="flex flex-col items-center">
      ...
      <p className="max-w-xl text-center text-2xl text-[#8b949e] mb-8 font-semibold">Flexible plans for every coder</p>
      <p className="max-w-xl text-center text-lg text-[#8b949e] mb-8">Coming soon: Transparent pricing and value-packed plans for individuals and teams.</p>
    </div>
  </div>
);
